...
export default function PayNowRoot() {
    ...
    <PayShell title="Pay Now">
      ...
      <Card title="Payment Categories">
        <div className="plans-pay-choice-grid">
          <Link
            className={`plans-pay-choice ${has.mobile ? "active" : ""}`}
            href={`/pay-now/mobile?planId=${encodeURIComponent(planId)}`}
          >
            Mobile
          </Link>
          <Link
            className={`plans-pay-choice ${has.crypto ? "active" : ""}`}
            href={`/pay-now/crypto?planId=${encodeURIComponent(planId)}`}
          >
            Crypto
          </Link>
          <Link
            className={`plans-pay-choice ${has.card ? "active" : ""}`}
            href={`/pay-now/card?planId=${encodeURIComponent(planId)}`}
          >
            Card
          </Link>
        </div>
